...
lookup_table_fname   = '../Repo/LookUpTable/lookup_table_15by15.fits'
lookup_exptime_fname = '../Repo/LookUpTable/sc8_expmap_G.fits'
lookup_noise_fname   = '../Repo/LookUpTable/sc8_varmap_G.fits'
lookup_Nside         = 4096

# flux limit
selection_logflux_limit = -100. # log of flux limit for 'fluxcut'
...
# extinction map
extinctionmap_fname = '../Repo/ExtinctionMaps/HFI_CompMap_ThermalDustModel_2048_R1.20.fits'
